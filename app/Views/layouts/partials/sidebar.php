      ...
      <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
        ...
        <div class="sidebar-wrapper">
          <nav class="mt-2" aria-label="Main navigation">
            ...
            >
              ...
              <li class="nav-item">
                <a href="<?= site_url('dashboard/settings') ?>" class="nav-link">
              ...
              <li class="nav-item">
                <a href="<?= site_url('admin/serials') ?>" class="nav-link">
                  <i class="nav-icon bi bi-qr-code-scan"></i>
                  <p><?= lang('App.serials') ?></p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?= site_url('admin/inventory/adjustments') ?>" class="nav-link">
                  <i class="nav-icon bi bi-clipboard-check"></i>
                  <p><?= lang('App.inventory_adjust') ?></p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?= site_url('admin/settings/wizard') ?>" class="nav-link">
        ...
        <div class="p-3 mt-3 border-top border-secondary border-opacity-25">
          <a
            href="https://adminlte.io/docs/4.0/"
            target="_blank"
